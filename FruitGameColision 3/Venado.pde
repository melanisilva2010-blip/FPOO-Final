...
class Venado {
  ...
  public void dibujar() {
    ...
    if (vida > 0) {
      ...
      if (animCaminar != null) {
        ...
        image(animCaminar, 0, 0, this.ancho, this.alto); 
  ...
  public void sumarPuntaje(int valor) { this.puntaje += valor; }
  public int getX() { return (int)(posicion.x); }
  public int getY() { return (int)(posicion.y); }
